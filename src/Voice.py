...
FOUR_VOICE = {
    'B': {'E': (2, 3, 4), 'F': (2, 3), 'F#': (2, 3), 'Gb': (2, 3), 'G': (2, 3), 'Ab': (2, 3), 'G#': (2, 3),
          'A': (2, 3), 'A#': (2, 3), 'Bb': (2, 3), 'B': (2, 3),  'C': (3, 4), 'C#': (3, 4), 'Db': (3, 4), 'D': (3, 4), 
          'Eb': (3, 4), 'D#': (3, 4)},
    'T': {'C': (3, 4, 5), 'C#': (3, 4), 'Db': (3, 4), 'D': (3, 4), 'Eb': (3, 4), 'D#': (3, 4), 'E': (3, 4), 
          'F': (3, 4), 'F#': (3, 4), 'Gb': (3, 4), 'G': (3, 4), 'Ab': (3, 4), 'G#': (3, 4), 'A': (3, 4), 
          'Bb': (3, 4), 'A#': (3, 4), 'B': (3, 4)},
    'A': {'F': (3, 4, 5), 'F#': (3, 4), 'Gb': (3, 4), 'G': (3, 4), 'Ab': (3, 4), 'G#': (3, 4), 'A': (3, 4), 'Bb': (3, 4), 
          'A#': (3, 4), 'B': (3, 4), 'C': (4, 5), 'C#': (4, 5), 'Db': (4, 5), 'D': (4, 5), 'Eb': (4, 5), 
          'D#': (4, 5), 'E': (4, 5)},
    'S': {'C': (4, 5, 6), 'C#': (4, 5), 'Db': (4, 5), 'D': (4, 5), 'Eb': (4, 5), 'D#': (4, 5), 'E': (4, 5), 'F': (4, 5), 
